...
from .application_models.CatalogValidator import CatalogValidator
from .application_models.CartValidator import CartValidator
from .application_models.CommonValidator import CommonValidator
from .application_models.LeadValidator import LeadValidator
from .application_models.ThemeValidator import ThemeValidator
from .application_models.UserValidator import UserValidator
from .application_models.ContentValidator import ContentValidator
from .application_models.CommunicationValidator import CommunicationValidator
from .application_models.ShareValidator import ShareValidator
from .application_models.FileStorageValidator import FileStorageValidator
from .application_models.ConfigurationValidator import ConfigurationValidator
from .application_models.PaymentValidator import PaymentValidator
from .application_models.OrderValidator import OrderValidator
from .application_models.RewardsValidator import RewardsValidator
from .application_models.FeedbackValidator import FeedbackValidator
from .application_models.PosCartValidator import PosCartValidator
from .application_models.LogisticValidator import LogisticValidator
...
class Catalog:
    ...
    async def getProductPriceBySlug(self, slug=None, size=None, pincode=None, store_id=None):
    ...
    async def getProductSellersBySlug(self, slug=None, size=None, pincode=None, strategy=None, page_no=None, page_size=None):
    ...
    async def getProductComparisonBySlugs(self, slug=None):
    ...
    async def getSimilarComparisonProductBySlug(self, slug=None):
    ...
    async def getComparedFrequentlyProductBySlug(self, slug=None):
    ...
    async def getProductSimilarByIdentifier(self, slug=None, similar_type=None):
    ...
    async def getProductVariantsBySlug(self, slug=None):
    ...
    async def getProductStockByIds(self, item_id=None, alu=None, sku_code=None, ean=None, upc=None):
    ...
    async def getProductStockForTimeByIds(self, timestamp=None, page_size=None, page_id=None):
    ...
    async def getProducts(self, q=None, f=None, filters=None, sort_on=None, page_id=None, page_size=None, page_no=None, page_type=None):
    ...
    async def getBrands(self, department=None, page_no=None, page_size=None):
    ...
    async def getBrandDetailBySlug(self, slug=None):
    ...
    async def getCategoryDetailBySlug(self, slug=None):
    ...
    async def getHomeProducts(self, sort_on=None, page_id=None, page_size=None):
    ...
    async def getSearchResults(self, q=None):
    ...
    async def getCollections(self, page_no=None, page_size=None, tag=None):
    ...
    async def getCollectionItemsBySlug(self, slug=None, f=None, filters=None, sort_on=None, page_id=None, page_size=None):
    ...
    async def getCollectionDetailBySlug(self, slug=None):
    ...
    async def getFollowedListing(self, collection_type=None, page_id=None, page_size=None):
    ...
    async def followById(self, collection_type=None, collection_id=None):
    ...
    async def unfollowById(self, collection_type=None, collection_id=None):
    ...
    async def getFollowerCountById(self, collection_type=None, collection_id=None):
    ...
    async def getFollowIds(self, collection_type=None):
    ...
    async def getStores(self, page_no=None, page_size=None, q=None, city=None, range=None, latitude=None, longitude=None):
    ...
    async def getInStockLocations(self, page_no=None, page_size=None, q=None, city=None, range=None, latitude=None, longitude=None):
        """Use this API to get a list of stores in a specific application.
        :param page_no : The page number to navigate through the given set of results. : type integer
        :param page_size : Number of items to retrieve in each page. : type integer
        :param q : Search a store by its name or store_code. : type string
    ...
    async def getLocationDetailsById(self, location_id=None):
...
class Cart:
    ...
    async def getCart(self, id=None, i=None, b=None, assign_card_id=None):
    ...
    async def addItems(self, i=None, b=None):
    ...
    async def updateCart(self, id=None, i=None, b=None):
    ...
    async def getItemCount(self, id=None):
    ...
    async def getCoupons(self, id=None):
    ...
    async def applyCoupon(self, i=None, b=None, p=None, id=None):
    ...
    async def removeCoupon(self, id=None):
    ...
    async def getBulkDiscountOffers(self, item_id=None, article_id=None, uid=None, slug=None):
    ...
    async def applyRewardPoints(self, id=None, i=None, b=None):
    ...
    async def getAddresses(self, cart_id=None, mobile_no=None, checkout_mode=None, tags=None, is_default=None):
    ...
    async def getAddressById(self, id=None, cart_id=None, mobile_no=None, checkout_mode=None, tags=None, is_default=None):
    ...
    async def updateAddress(self, id=None):
    ...
    async def removeAddress(self, id=None):
    ...
    async def selectAddress(self, cart_id=None, i=None, b=None):
    ...
    async def selectPaymentMode(self, id=None):
    ...
    async def validateCouponForPayment(self, id=None, address_id=None, payment_mode=None, payment_identifier=None, aggregator_name=None, merchant_code=None):
    ...
    async def getShipments(self, p=None, id=None, address_id=None, area_code=None):
    ...
    async def updateCartMeta(self, id=None):
    ...
    async def getCartShareLink(self, ):
...
class Lead:
    ...
    async def createHistory(self, id=None):
    ...
    async def submitCustomForm(self, slug=None):
    ...
    async def getParticipantsInsideVideoRoom(self, unique_name=None):
...
class User:
    ...
    async def loginWithFacebook(self, platform=None):
    ...
    async def loginWithGoogle(self, platform=None):
    ...
    async def loginWithGoogleOauth(self, platform=None, redirect_url=None):
        """Use this API to login or register using Google Account credentials.
        :param platform : ID of the application : type string
        :param redirect_url : Url to redirect after login : type string
        """
        payload = {}
        ...
        schema = UserValidator.loginWithGoogleOauth()
        schema.dump(schema.load(payload))

        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/user/authentication/v1.0/login/google", """{"required":[],"optional":[{"name":"platform","in":"query","description":"ID of the application","schema":{"type":"string","default":"Fynd"}},{"name":"redirect_url","in":"query","description":"Url to redirect after login","schema":{"type":"string","default":"https://www.fynd.com/"}}],"query":[{"name":"platform","in":"query","description":"ID of the application","schema":{"type":"string","default":"Fynd"}},{"name":"redirect_url","in":"query","description":"Url to redirect after login","schema":{"type":"string","default":"https://www.fynd.com/"}}],"headers":[]}""", platform=platform, redirect_url=redirect_url)
        query_string = await create_query_string(platform=platform, redirect_url=redirect_url)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/user/authentication/v1.0/login/google", platform=platform, redirect_url=redirect_url), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}))
    
    async def loginWithGoogleAndroid(self, platform=None):
    ...
    async def loginWithGoogleIOS(self, platform=None):
    ...
    async def loginWithAppleIOS(self, platform=None):
    ...
    async def loginWithOTP(self, platform=None):
    ...
    async def loginWithEmailAndPassword(self, ):
    ...
    async def sendResetPasswordEmail(self, platform=None):
    ...
    async def registerWithForm(self, platform=None):
    ...
    async def sendOTPOnMobile(self, platform=None):
    ...
    async def verifyMobileOTP(self, platform=None):
    ...
    async def sendOTPOnEmail(self, platform=None):
    ...
    async def verifyEmailOTP(self, platform=None):
    ...
    async def getLoggedInUser(self, ):
    ...
    async def getListOfActiveSessions(self, ):
    ...
    async def getPlatformConfig(self, name=None):
    ...
    async def updateProfile(self, platform=None):
    ...
    async def addMobileNumber(self, platform=None):
    ...
    async def deleteMobileNumber(self, platform=None, active=None, primary=None, verified=None, country_code=None, phone=None):
    ...
    async def setMobileNumberAsPrimary(self, ):
    ...
    async def sendVerificationLinkToMobile(self, platform=None):
    ...
    async def addEmail(self, platform=None):
    ...
    async def deleteEmail(self, platform=None, active=None, primary=None, verified=None, email=None):
    ...
    async def setEmailAsPrimary(self, ):
    ...
    async def sendVerificationLinkToEmail(self, platform=None):
...
class Content:
    ...
    async def getAnnouncements(self, ):
    ...
    async def getBlog(self, slug=None, root_id=None):
    ...
    async def getFaqBySlug(self, slug=None):
    ...
    async def getFaqCategoryBySlug(self, slug=None):
    ...
    async def getFaqsByCategorySlug(self, slug=None):
    ...
    async def getNavigations(self, page_no=None, page_size=None):
    ...
    async def getPage(self, slug=None, root_id=None):
        ...
        :param slug : A short, human-readable, URL-friendly identifier of a page. You can get slug value from the endpoint /service/application/content/v1.0/pages/. : type string
        :param root_id : ID given to the HTML element : type string
        """
        payload = {}
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/pages/{slug}", """{"required":[{"name":"slug","in":"path","description":"A short, human-readable, URL-friendly identifier of a page. You can get slug value from the endpoint /service/application/content/v1.0/pages/.","required":true,"schema":{"type":"string"}}],"optional":[{"name":"root_id","in":"query","description":"ID given to the HTML element","required":false,"schema":{"type":"string"}}],"query":[{"name":"root_id","in":"query","description":"ID given to the HTML element","required":false,"schema":{"type":"string"}}],"headers":[]}""", slug=slug, root_id=root_id)
        query_string = await create_query_string(slug=slug, root_id=root_id)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/content/v1.0/pages/{slug}", slug=slug, root_id=root_id), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}))
    ...
    async def getPages(self, page_no=None, page_size=None):
        ...
        url_with_params = await create_url_with_params(self._conf.domain, "/service/application/content/v1.0/pages/", """{"required":[],"optional":[{"name":"page_no","in":"query","description":"The page number to navigate through the given set of results. Default value is 1. ","required":false,"schema":{"type":"integer","default":1}},{"name":"page_size","in":"query","description":"The number of items to retrieve in each page.","required":false,"schema":{"type":"integer","default":10}}],"query":[{"name":"page_no","in":"query","description":"The page number to navigate through the given set of results. Default value is 1. ","required":false,"schema":{"type":"integer","default":1}},{"name":"page_size","in":"query","description":"The number of items to retrieve in each page.","required":false,"schema":{"type":"integer","default":10}}],"headers":[]}""", page_no=page_no, page_size=page_size)
        query_string = await create_query_string(page_no=page_no, page_size=page_size)
        return await AiohttpHelper().aiohttp_request("GET", url_with_params, headers=await get_headers_with_signature(self._conf.domain, "get", await create_url_without_domain("/service/application/content/v1.0/pages/", page_no=page_no, page_size=page_size), query_string, {"Authorization": "Bearer " + base64.b64encode("{}:{}".format(self._conf.applicationID, self._conf.applicationToken).encode()).decode()}))
    ...
    async def getSlideshows(self, page_no=None, page_size=None):
    ...
    async def getSlideshow(self, slug=None):
    ...
    async def getPageV2(self, slug=None, root_id=None):
        """Use this API to get the details of a page using its slug. Details include the title, seo, publish status, feature image, tags, meta, etc.
        :param slug : A short, human-readable, URL-friendly identifier of a page. You can get slug value from the endpoint /service/application/content/v1.0/pages/. : type string
        :param root_id : ID given to the HTML element : type string
        """
        ...
        schema = ContentValidator.getPageV2()
        schema.dump(schema.load(payload))
    ...
    async def getPagesV2(self, page_no=None, page_size=None):
        """Use this API to get a list of pages.
        :param page_no : The page number to navigate through the given set of results. Default value is 1.  : type integer
        :param page_size : The number of items to retrieve in each page. : type integer
        """
        ...
        schema = ContentValidator.getPagesV2()
        schema.dump(schema.load(payload))
...
class Communication:
    ...
    async def getCommunicationConsent(self, ):
    ...
    async def upsertCommunicationConsent(self, ):
    ...
    async def upsertAppPushtoken(self, ):
...
class Share:
    ...
    async def getApplicationQRCode(self, ):
    ...
    async def getProductQRCodeBySlug(self, slug=None):
    ...
    async def getCollectionQRCodeBySlug(self, slug=None):
    ...
    async def getUrlQRCode(self, url=None):
    ...
    async def createShortLink(self, ):
    ...
    async def getOriginalShortLinkByHash(self, hash=None):
...
class FileStorage:
    ...
    async def startUpload(self, namespace=None):
...
This operation will return the URL of the uploaded file.
    ...
    async def completeUpload(self, namespace=None):
...
class Configuration:
    ...
    async def getBasicDetails(self, ):
    ...
    async def getIntegrationTokens(self, ):
    ...
    async def getOrderingStores(self, page_no=None, page_size=None, q=None):
    ...
    async def getStoreDetailById(self, store_id=None):
    ...
    async def getCurrencyById(self, id=None):
    ...
    async def getAppCurrencies(self, ):
    ...
    async def getOrderingStoreCookie(self, ):
    ...
    async def getAppStaffs(self, order_incent=None, ordering_store=None, user=None):
...
class Payment:
    ...
    async def getAggregatorsConfig(self, x_api_token=None, refresh=None):
    ...
    async def attachCardToCustomer(self, ):
    ...
    async def getActiveCardAggregator(self, refresh=None):
    ...
    async def getActiveUserCards(self, force_refresh=None):
    ...
    async def verifyCustomerForPayment(self, ):
    ...
    async def verifyAndChargePayment(self, ):
    ...
    async def initialisePayment(self, ):
    ...
    async def checkAndUpdatePaymentStatus(self, ):
    ...
    async def getPaymentModeRoutes(self, amount=None, cart_id=None, pincode=None, checkout_mode=None, refresh=None, card_reference=None, user_details=None):
    ...
    async def getRupifiBannerDetails(self, ):
    ...
    async def getActiveRefundTransferModes(self, ):
    ...
    async def enableOrDisableRefundTransferMode(self, ):
    ...
    async def getUserBeneficiariesDetail(self, order_id=None):
    ...
    async def getOrderBeneficiariesDetail(self, order_id=None):
        """Use this API to get the details of all active beneficiary added by a user for refund.
        :param order_id : A unique number used for identifying and tracking your orders. : type string
        """
        payload = {}
    ...
    async def verifyOtpAndAddBeneficiaryForBank(self, ):
    ...
    async def addBeneficiaryDetails(self, ):
    ...
    async def addRefundBankAccountUsingOTP(self, ):
    ...
    async def verifyOtpAndAddBeneficiaryForWallet(self, ):
    ...
    async def updateDefaultBeneficiary(self, ):
...
class Order:
    ...
    async def getOrders(self, page_no=None, page_size=None, from_date=None, to_date=None, status=None):
    ...
    async def getShipmentById(self, shipment_id=None):
    ...
    async def getShipmentReasons(self, shipment_id=None):
    ...
    async def updateShipmentStatus(self, shipment_id=None):
    ...
    async def trackShipment(self, shipment_id=None):
    ...
    async def getPosOrderById(self, order_id=None):
    ...
    async def getCustomerDetailsByShipmentId(self, order_id=None, shipment_id=None):
    ...
    async def sendOtpToShipmentCustomer(self, order_id=None, shipment_id=None):
    ...
    async def verifyOtpShipmentCustomer(self, order_id=None, shipment_id=None):
...
class Rewards:
    ...
    async def getPointsOnProduct(self, ):
    ...
    async def getOrderDiscount(self, ):
    ...
    async def getUserPointsHistory(self, page_id=None, page_size=None):
    ...
    async def getUserReferralDetails(self, ):
    ...
    async def redeemReferralCode(self, ):
...
class Feedback:
    ...
    async def createAbuseReport(self, ):
    ...
    async def updateAbuseReport(self, ):
    ...
    async def getAbuseReports(self, entity_id=None, entity_type=None, id=None, page_id=None, page_size=None):
    ...
    async def createAttribute(self, ):
    ...
    async def getAttribute(self, slug=None):
    ...
    async def updateAttribute(self, slug=None):
    ...
    async def getComments(self, entity_type=None, id=None, entity_id=None, user_id=None, page_id=None, page_size=None):
    ...
    async def checkEligibility(self, entity_type=None, entity_id=None):
    ...
    async def deleteMedia(self, ids=None):
    ...
    async def getMedias(self, entity_type=None, entity_id=None, id=None, type=None, page_id=None, page_size=None):
    ...
    async def getReviewSummaries(self, entity_type=None, entity_id=None, id=None, page_id=None, page_size=None):
    ...
    async def getReviews(self, entity_type=None, entity_id=None, id=None, user_id=None, media=None, rating=None, attribute_rating=None, facets=None, sort=None, active=None, approve=None, page_id=None, page_size=None):
    ...
    async def getTemplates(self, template_id=None, entity_id=None, entity_type=None):
    ...
    async def getQuestionAndAnswers(self, entity_type=None, entity_id=None, id=None, user_id=None, show_answer=None, page_id=None, page_size=None):
    ...
    async def getVotes(self, id=None, ref_type=None, page_no=None, page_size=None):
...
class PosCart:
    ...
    async def updateShipments(self, i=None, p=None, id=None, address_id=None, order_type=None):
    ...
    async def checkoutCart(self, id=None):
...
class Logistic:
    ...
    async def getPincodeCity(self, pincode=None):
